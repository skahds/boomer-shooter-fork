...
AddTarget("DEMONCHIME", "exe", {
  src = {
    ...
    "core/gfx/buffer_object.c",
    "core/gfx/buffer_object.h",
    "core/gfx/framebuffer.c",
    ...
    "core/gfx/opengl/gl_buffer_object.c",
    "core/gfx/opengl/gl_buffer_object.h",
    "core/gfx/opengl/gl_framebuffer.c",
    "core/gfx/opengl/gl_framebuffer.h",
    "core/gfx/opengl/gl_gfx.c",
    "core/gfx/opengl/gl_gfx.h",
    "core/gfx/opengl/gl_shader.c",
    "core/gfx/opengl/gl_shader.h",
    "core/gfx/opengl/gl_texture.c",
    "core/gfx/opengl/gl_type_conv.c",
    "core/gfx/opengl/gl_type_conv.h",
    "core/gfx/opengl/gl_vertex_array.c",
    "core/gfx/opengl/gl_vertex_array.h",
  },
  include = {
    "core",
    "lib/luajit/src",
